...
function Overview() {
  ...
  return (
    <>
      <Head>
        <title>Flair My Event : Sign up</title>
      </Head>
              ...
              <div className={Mstyles.logomainBox}>
                <div>
                  ...
                  <div style={{ height: '50px' }}> </div>
                    ...
                    <div><h2>Create Flair My Event Account </h2>
                      <div style={{ height: '10px' }}> </div>
                    ...
                    <div className={Mstyles.Extraloginbox}>
                      <div style={{ height: '15px' }}> </div>
                      <h4>Already have an  <span className={Mstyles.PrimatryText}>Flair My Event </span> account ?</h4>
                      <div style={{ height: '10px' }}></div>
                      <LoadingButton
