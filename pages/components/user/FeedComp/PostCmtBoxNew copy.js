...
const PostCmtBoxNew = ({ PostData }) => {
    ...
    const [openReplayIndex, setOpenReplayIndex] = useState(null);

    const ClickEdit = (index) => {

        setOpenCategoryIndex(openCategoryIndex === index ? null : index);
    };
    const CmtReply = (index) => {

        setOpenReplayIndex(openReplayIndex === index ? null : index);
    };
    ...
    const ReplayAdded = (updatedComment) => {
                                        ...
                                        <div className={Mstyles.CmtlistItemB}>
                                            ...
                                            {Contextdata.UserLogin &&
                                                <div>
                                                    ...
                                                    <div className={Mstyles.CmtEditDeletebox}>
                                                        <div className={Mstyles.CmtEditDeleteitem} onClick={() => CmtReply(index)}>
                                                            {item.ChildCmt.length > 0 ?<span>View {item.ChildCmt.length} Replies</span> :<span>Replay</span>}
                                                        </div>
                                                    ...
                                                    <div>
                                                        <ReplayComment
                                                            isOpen={openReplayIndex === index}
                                                            ParentCmt={item}
                                                            PostData={PostData}
                                                            handleClose={() => setOpenReplayIndex(null)}
