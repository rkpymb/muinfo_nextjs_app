    ...
    return (
        <div className={Mstyles.HBoxCont}>
            ...
            <div className={Mstyles.HBoxOverlay}>
                <div className={Mstyles.HBoxOverlayContentBox}>

                    <div className={Mstyles.HBoxOverlayContentA}>
                        {data.length > 0 ? <div>
                        ...
                        <div style={{ height: 10 }}></div>
                        <div className={Mstyles.Sboxmmm}>

                            <Searchbox SType={1} />
                        </div>

                    </div>
                    <div className={Mstyles.HBoxOverlayContentB}>
                        {!isLoading &&
